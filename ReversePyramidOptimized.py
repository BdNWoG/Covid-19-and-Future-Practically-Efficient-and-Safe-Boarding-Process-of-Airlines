...
print("Output: ")
print("Model: Reverse Pyramid Optimized Boarding")
            ...
            for i in range(11):
                  ...
                  while done == False:
                        ...
                        if l < 0:
                              l = luggage/2
                        if plane2[r+1][c] == 's':
                              a = [i+j*11+1+123, [r+1, c], l]
                              (plane2[r+1])[c] = str(i+j*11+1+123)
                              passenger.append(a)
                              plugload.append(int(0))
                              shimmer.append(int(0))
                              done = True
            ...
            for i in range(4-j):
                  ...
                  while done == False:
                        ...
                        if l < 0:
                              l = luggage/2
                        if plane2[r+1][c] == 's':
                              a = [i+j*4+1+145, [r+1, c], l]
                              (plane2[r+1])[c] = str(i+j*4+1+145)
                              passenger.append(a)
                              plugload.append(int(0))
                              shimmer.append(int(0))
                              done = True
            ...
            for i in range(22-j):
                  ...
                  while done == False:
                        ...
                        if l < 0:
                              l = luggage/2
                        if plane2[r+1][c] == 's':
                              a = [i+j*22+1+152, [r+1, c], l]
                              (plane2[r+1])[c] = str(i+j*22+1+152)
                              passenger.append(a)
                              plugload.append(int(0))
                              shimmer.append(int(0))
                              done = True
