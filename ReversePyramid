...
print("Output: ")
print("Model: Reverse Pyramid Boarding")
      ...
      for i in range(36):
            ...
            while done == False:
                  ...
                  if c == 2:
                        ...
                        c = 6
                  if c == 1 or c == 5:
                        r = random.randint(0, 10) + 22
                  else:
                        r = random.randint(0, 6) + 4
                  l = np.random.normal(luggage/2, luggage/4, 1)[0]
                  if l < 0:
                         l = luggage/2
                  if plane2[r+1][c] == 's':
                        a = [i+1+44, [r+1, c], l]
                        (plane2[r+1])[c] = str(i+1+44)
                        passenger.append(a)
                        plugload.append(int(0))
                        shimmer.append(int(0))
                        done = True
