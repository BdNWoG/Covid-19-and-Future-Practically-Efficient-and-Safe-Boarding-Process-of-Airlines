...
print("Output: ")
print("Model: Boarding by Aisle 70%")
      ...
      for i in range(int(32)):
            ...
            while done == False:
                  ...
                  if l < 0:
                        l = luggage/2
                  if plane2[r+1][c] == 's':
                        a = [i+1+33*2+32, [r+1, c], l]
                        (plane2[r+1])[c] = str(i+1+33*2+32)
                        passenger.append(a)
                        plugload.append(int(0))
                        shimmer.append(int(0))
                        done = True
